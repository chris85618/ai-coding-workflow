...
class TestCompletionCheckScenarios:
    """BDD scenarios for completion check."""

    @staticmethod
    @scenario("features/completion_check.feature", "All checks pass and ship is allowed")
    def test_all_pass() -> None:
        """SC-009: All sub-checks pass → ship allowed."""

    @staticmethod
    @scenario("features/completion_check.feature", "Traceability integrity fails and blocks ship")
