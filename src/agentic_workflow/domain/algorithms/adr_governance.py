...
class ADRGovernance:
    """Manages Architecture Decision Records classification, lifecycle, and formatting."""
    ...
    @classmethod
    def evaluate_decision_unit(cls, statement: str, cohesiveness: float, consequences_coupled: bool, atomic: bool) -> bool:
