...
class TestSecurityAuditScenarios:
    """BDD scenarios for security audit."""

    @staticmethod
    @scenario("features/security_audit.feature", "All three layers pass")
    def test_all_layers_pass() -> None:
        """SC-006: All 3 security layers pass."""

    @staticmethod
    @scenario("features/security_audit.feature", "Layer 2 HIGH finding triggers redesign")
