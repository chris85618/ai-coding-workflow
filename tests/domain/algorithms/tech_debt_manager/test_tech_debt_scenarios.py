...
class TestTechDebtScenarios:
    """BDD scenarios for tech debt."""

    @staticmethod
    @scenario("features/tech_debt.feature", "SonarCloud finding converts to tech debt")
    def test_finding_to_debt() -> None:
        """SC-008: SonarCloud finding → DEBT ID."""

    @staticmethod
    @scenario("features/tech_debt.feature", "RICE score is calculated correctly")
