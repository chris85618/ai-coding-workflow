...
class TestImpactAnalysisService:
    ...
    def test_analyze_change_cosmetic(self) -> None:
        ...
        result = service.analyze_change("FR-001", [])
    ...
    def test_analyze_change_minor(self) -> None:
        ...
        service = ImpactAnalysisService()
        result = service.analyze_change("FR-001", [], _downstream=["FR-002", "FR-003"])
    ...
    def test_analyze_change_moderate(self) -> None:
        ...
        service = ImpactAnalysisService()
        result = service.analyze_change("FR-001", [], _downstream=["FR-002", "FR-003", "FR-004", "FR-005"])
    ...
    def test_analyze_change_major(self) -> None:
        ...
        service = ImpactAnalysisService()
        result = service.analyze_change("FR-001", [], _downstream=[f"FR-{i:03d}" for i in range(2, 13)])
